...
class DedupeTests(unittest.TestCase):
    ...
    def test_same_posting_is_submitted_only_once(self):
        plan = plan_for(posting(job_id="dup-1"))
    ...
    def test_attempt_recorded_before_submission(self):
        plan = plan_for(posting(job_id="dup-2"))
    ...
    def test_different_postings_both_submitted(self):
        self.applier.process(plan_for(posting(job_id="a")))
        self.applier.process(plan_for(posting(job_id="b")))
